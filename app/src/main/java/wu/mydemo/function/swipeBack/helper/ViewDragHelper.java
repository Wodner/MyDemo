...
package wu.mydemo.function.swipeBack.helper;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.example.swipebackactivity.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.swipebackactivity.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.example.swipebackactivity.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.example.swipebackactivity.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
